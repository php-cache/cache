...
class IntegrationTagTest extends TaggableCachePoolTest
{
    protected array $skippedTests = [
        ...
        'testInvalidateTagsValidatesEveryTagBeforeMutation' => 'Void adapter does not save,',
        ...
        'testNumericStringTagsRemainUsable' => 'Void adapter does not save,',
        'testTagNamesOutsidePortableKeyAlphabetRemainUsable' => 'Void adapter does not save,',
